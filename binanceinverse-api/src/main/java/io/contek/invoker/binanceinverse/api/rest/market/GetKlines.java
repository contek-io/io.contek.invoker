...
import io.contek.invoker.binanceinverse.api.common._Candlestick;
import io.contek.invoker.binanceinverse.api.rest.market.GetKlines.Response;
...
public final class GetKlines extends MarketRestRequest<Response> {
  ...
  public static final int MAX_LIMIT = 1500;
