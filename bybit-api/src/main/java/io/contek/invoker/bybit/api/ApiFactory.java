...
public final class ApiFactory {
  ...
  public static final ApiContext MAIN_NET_CONTEXT =
      ApiContext.newBuilder()
          .setRestContext(RestContext.of("https://api.bybit.com"))
          .setWebSocketContext(WebSocketContext.of("wss://stream.bybit.com"))
          .build();

  public static final ApiContext TEST_NET_CONTEXT =
      ApiContext.newBuilder()
          .setRestContext(RestContext.of("https://api-testnet.bybit.com"))
          .setWebSocketContext(WebSocketContext.of("wss://stream-testnet.bybit.com"))
          .build();
