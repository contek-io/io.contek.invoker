package io.contek.invoker.bybitinverse.api.rest.user;

import com.google.common.collect.ImmutableList;
import io.contek.invoker.bybitinverse.api.ApiFactory;
import io.contek.invoker.bybitinverse.api.common._OrderCancelAll;
...
import static io.contek.invoker.bybitinverse.api.rest.user.PostOrderCancelAll.Response;
...
public final class PostOrderCancelAll extends UserRestRequest<Response> {
  ...
  @NotThreadSafe
  public static final class Response extends ResponseWrapper<List<_OrderCancelAll>> {}
}
