package io.contek.invoker.bybitinverse.api.rest.market;

import com.google.common.collect.ImmutableList;
import io.contek.invoker.bybitinverse.api.ApiFactory;
import io.contek.invoker.bybitinverse.api.rest.RestRequest;
...
abstract class MarketRestRequest<T extends ResponseWrapper<?>> extends RestRequest<T> {
  ...
  protected ImmutableList<TypedPermitRequest> getRequiredQuotas() {
    return ApiFactory.RateLimits.ONE_REST_PUBLIC_GET_REQUEST;
  }
}
