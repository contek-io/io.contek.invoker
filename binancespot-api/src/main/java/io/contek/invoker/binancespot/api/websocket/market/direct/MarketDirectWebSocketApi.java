...
import io.contek.invoker.binancespot.api.websocket.market.*;
...
public final class MarketDirectWebSocketApi implements IMarketWebSocketApi {
  ...
  @Override
  public IWebSocketChannel<DepthDiffEvent> getDepthDiffChannel(String symbol, String interval) {
  ...
  @Override
  public IWebSocketChannel<DepthPartialEvent> getDepthPartialChannel(
