...
public final class DepthPartialChannel
  ...
  DepthPartialChannel(DepthPartialChannel.Id id, WebSocketRequestIdGenerator requestIdGenerator) {
  ...
  @Immutable
  public static final class Id extends MarketWebSocketChannelId<DepthPartialChannel.Message> {
