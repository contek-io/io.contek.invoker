...
public final class ApiFactory {
  ...
  public static final ApiContext MAIN_NET_CONTEXT =
      ApiContext.newBuilder()
          .setRestContext(RestContext.of("https://fapi.binance.com"))
          .setWebSocketContext(WebSocketContext.of("wss://fstream.binance.com"))
          .build();

  public static final ApiContext TEST_NET_CONTEXT =
      ApiContext.newBuilder()
          .setRestContext(RestContext.of("https://testnet.binancefuture.com"))
          .setWebSocketContext(WebSocketContext.of("wss://stream.binancefuture.com"))
          .build();
