...
@NotThreadSafe
public class PostRequestWithdrawal
    extends OTCWithdrawalsRestRequest<PostRequestWithdrawal.Response> {
  ...
  protected RestParams getParams() {
    ...
    RestParams.Builder builder =
        RestParams.newBuilder().add("coin", coin).add("address", address).add("size", size);
